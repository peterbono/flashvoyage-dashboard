    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-0.5">
            LLM and infrastructure cost tracking
          </p>
        </div>
      ...
      <div className="flex items-center justify-center h-96 border border-dashed border-zinc-800 rounded-xl">
        <div className="text-center">
          ...
          <p className="text-sm text-zinc-500 font-medium">Cost Tracker</p>
          <p className="text-xs text-zinc-600 mt-1">Recharts + daily/monthly breakdown — Phase 1</p>
        </div>
      </div>
    </div>
  );
