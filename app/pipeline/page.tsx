    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-0.5">
            Article flow visualization — idea → published
          </p>
        </div>
      ...
      <div className="flex items-center justify-center h-96 border border-dashed border-zinc-800 rounded-xl">
        <div className="text-center">
          ...
          <p className="text-sm text-zinc-500 font-medium">Pipeline Visualizer</p>
          <p className="text-xs text-zinc-600 mt-1">React Flow + ELK.js — Phase 1</p>
        </div>
      </div>
    </div>
  );
